...
from action_space import generate_candidate_actions # Import action generation
# Import the *new* prediction function and other utils
from utils import predict_multiple_next_states, avoid_obstacle, calculate_extrinsic_utility # Assuming utility is also in utils now
